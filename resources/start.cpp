...
void compile_cpp_file(std::string path_to_directory, std::string name_no_cpp) {

    std::string cpp_name = name_no_cpp + ".cpp";

    std::string command = "g++ " + path_to_directory + cpp_name + " -o " + path_to_directory + name_no_cpp;
    std::system(command.c_str());
}

void start_cpp_binary_file(std::string path_to_directory_binary_file) {
    system(path_to_directory_binary_file.c_str());
}
